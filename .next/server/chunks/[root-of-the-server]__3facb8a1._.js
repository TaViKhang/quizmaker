...
"[project]/.next-internal/server/app/api/classes/join/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/classes/join/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const joinClassWithCodeSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
...
const joinClassWithIdSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
    classId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string({
...
async function POST(request) {
    try {
        ...
        if (session.user.role !== __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Role"].STUDENT) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPermissionError"])("Only students can join classes");
        }
        ...
        if (body.code) {
            ...
            if (!validationResult.success) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])("VALIDATION_ERROR", "Invalid data", (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatZodError"])(validationResult.error));
            }
            const { code } = validationResult.data;
            // Check if the class exists
            classToJoin = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].class.findUnique({
                where: {
                    code,
                    isActive: true
                },
            ...
            classToJoin = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].class.findFirst({
                where: {
                    id: classId,
                    isActive: true,
                    type: __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["ClassType"].PUBLIC
                },
                include: {
                    _count: {
                        select: {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])("VALIDATION_ERROR", "Either class code or class ID is required");
        }
        if (!classToJoin) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createNotFoundError"])("Class not found, is not active, or requires a join code");
        }
        // Check if the class is full
        if (classToJoin.maxStudents !== null && classToJoin._count.students >= classToJoin.maxStudents) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])("CLASS_FULL", "This class is full and cannot accept more students");
        }
        // Teachers cannot join their own classes
        if (classToJoin.teacherId === session.user.id) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])("INVALID_JOIN", "You cannot join a class you are teaching");
        }
        // Check if student is already enrolled
        const existingEnrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].classEnrollment.findFirst({
            where: {
        ...
        if (existingEnrollment) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])("ALREADY_ENROLLED", "You are already enrolled in this class");
        }
        // Create enrollment
        const enrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].classEnrollment.create({
            data: {
                classId: classToJoin.id,
                studentId: session.user.id
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3facb8a1._.js.map
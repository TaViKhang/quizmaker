...
"[project]/.next-internal/server/app/api/teacher/quizzes/[quizId]/duplicate/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/teacher/quizzes/[quizId]/duplicate/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    try {
        ...
        const originalQuiz = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].quiz.findUnique({
            where: {
                id: quizId
            },
            include: {
        ...
        if (originalQuiz.authorId !== session.user.id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Forbidden: You don't have permission to duplicate this quiz"
            }, {
                status: 403
            });
        }
        // Create a new quiz as a copy
        const newQuiz = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].quiz.create({
            data: {
        ...
        if (originalQuiz.questions.length > 0) {
            for (const question of originalQuiz.questions){
                // Create new question
                const newQuestion = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.create({
                    data: {
                        quizId: newQuiz.id,
                ...
                if (question.options.length > 0) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].option.createMany({
        ...
        const completeNewQuiz = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].quiz.findUnique({
            where: {
                id: newQuiz.id
            },
            include: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(transformedQuiz);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__78b27d82._.js.map
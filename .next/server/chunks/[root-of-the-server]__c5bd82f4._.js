...
"[project]/.next-internal/server/app/api/classes/[id]/announcements/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/classes/[id]/announcements/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const createAnnouncementSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
    ...
    content: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(1, "Content is required").max(5000, "Content too long")
});
async function GET(request, { params }) {
    try {
        ...
        const total = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].classAnnouncement.count({
            where
        });
        // Fetch announcements with pagination
        const announcements = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].classAnnouncement.findMany({
            where,
            orderBy: {
                createdAt: 'desc'
            },
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPaginatedResponse"])(announcements, total, page, limit, {
            filters: {
                search
            },
...
async function POST(request, { params }) {
    try {
        ...
        if (session.user.role !== __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Role"].TEACHER) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPermissionError"])("Only teachers can create announcements");
        }
        const classId = params.id;
        // Check if class exists and teacher owns it
        const classItem = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].class.findFirst({
            where: {
                id: classId,
                teacherId: session.user.id
            }
        ...
        if (!classItem) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createNotFoundError"])("Class not found or you don't have permission to create announcements");
        }
        const body = await request.json();
        // Validate input
        const validationResult = createAnnouncementSchema.safeParse(body);
        if (!validationResult.success) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createErrorResponse"])("VALIDATION_ERROR", "Invalid announcement data", validationResult.error.errors);
        }
        const { title, content } = validationResult.data;
        // Create new announcement
        const newAnnouncement = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].classAnnouncement.create({
            data: {
                title,
                content,
                class: {
        ...
        const { triggerClassAnnouncementNotification } = await __turbopack_context__.r("[project]/lib/service-trigger.ts [app-route] (ecmascript, async loader)")(__turbopack_context__.i);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5bd82f4._.js.map
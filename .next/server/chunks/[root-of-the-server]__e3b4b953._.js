...
"[project]/.next-internal/server/app/api/users/me/dashboard-summary/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/users/me/dashboard-summary/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const classesJoined = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].classEnrollment.count({
            where: {
                studentId: userId,
                class: {
                    isActive: true
        ...
        if (enrolledClassIds.length > 0) {
            assignedPublishedQuizzesCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].quiz.count({
                where: {
                    classId: {
                        in: enrolledClassIds
                    },
        ...
        const completedQuizAttempts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].quizAttempt.findMany({
            where: {
                userId: userId,
                completedAt: {
                    not: null
        ...
        const assignedQuizzes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].quiz.findMany({
            where: {
                classId: {
                    in: enrolledClassIds
                },
        ...
        const allAttempts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].quizAttempt.findMany({
            where: {
                userId: userId,
                quizId: {
                    in: assignedQuizIds
        ...
        if (enrolledClassIds.length > 0) {
            assignedPublishedQuizzesCurrentMonthCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].quiz.count({
                where: {
                    classId: {
                        in: enrolledClassIds
                    },
        ...
        const completedQuizCurrentMonthAttempts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].quizAttempt.findMany({
            where: {
                userId: userId,
                completedAt: {
                    not: null,
        ...
        const previousMonthAttempts = allAttempts.filter((attempt)=>attempt.completedAt && new Date(attempt.completedAt) >= previousMonth && new Date(attempt.completedAt) < currentMonth);
        // Group by quiz and find highest score per quiz
        const previousMonthBestScores = new Map();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3b4b953._.js.map
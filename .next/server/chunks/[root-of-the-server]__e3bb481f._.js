...
"[project]/.next-internal/server/app/api/notifications/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function DELETE(request, { params }) {
    try {
        ...
        const notification = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].notification.findUnique({
            where: {
                id: notificationId
            },
            select: {
        ...
        if (!notification) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createNotFoundError"])("Notification not found");
        }
        // Check if the notification belongs to the current user
        if (notification.userId !== session.user.id) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPermissionError"])("You can only delete your own notifications");
        }
        // Delete the notification
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].notification.delete({
            where: {
                id: notificationId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e3bb481f._.js.map
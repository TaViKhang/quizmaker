...
'use client';
;
function MultipleChoiceQuestion({ options, allowMultiple = false, selectedOption = null, selectedOptions = [], onChange }) {
...
'use client';
;
function EssayQuestion({ minWords, maxWords, placeholder = "Enter your answer here...", richText = false, value, onChange }) {
    _s();
    const [text, setText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(value || '');
...
_s(EssayQuestion, "zujav2lG6wOvldxaD38/HnCQJks=");
_c = EssayQuestion;
var _c;
...
'use client';
;
function FillBlankQuestion({ text, options, caseSensitive, existingAnswer, onChange }) {
    _s();
    ...
    // Update blanks when existingAnswer changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FillBlankQuestion.useEffect": ()=>{
            if (existingAnswer) {
                setBlanks(existingAnswer);
            }
        }
    }["FillBlankQuestion.useEffect"], [
        existingAnswer
...
'use client';
;
function MatchingQuestion({ options, existingAnswer, onChange }) {
    _s();
    ...
    // Update matches when existingAnswer changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
'use client';
;
function CodeQuestion({ language = 'javascript', placeholder = '// Write your code here...', initialCode = '', value, onChange }) {
    _s();
    ...
    // Update code when value changes from parent
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            ...
            case 'SHORT_ANSWER':
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$student$2f$quizzes$2f5b$quizId$5d2f$attempt$2f$essay$2d$question$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EssayQuestion"], {
                    question: {
                        ...
                        metadata: {
                            ...question.metadata,
                            maxWords: question.metadata?.maxWords || 50,
                            richText: false
                        }
                    },
                    textAnswer: currentAnswer.textAnswer || '',
...
_s(QuestionRenderer, "UYCieJQXmSFWl4DmPInmA1XiQ90=");
_c = QuestionRenderer;
var _c;
...
//# sourceMappingURL=_8edfacd5._.js.map
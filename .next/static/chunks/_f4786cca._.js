...
function EssayQuestion({ question, textAnswer, onChange }) {
    ...
    // Extract metadata
    const { minWords, maxWords, placeholder = "Enter your answer here...", richText = false } = question.metadata || {};
    // Count words in the text
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EssayQuestion.useEffect": ()=>{
            if (textAnswer?.trim()) {
                // Remove HTML tags for word counting if rich text
                const plainText = richText ? textAnswer.replace(/<[^>]+>/g, ' ') : textAnswer;
...
_s(EssayQuestion, "O6G3Skvkh4uDVjCCPfELJ7sCGm0=");
_c = EssayQuestion;
var _c;
...
function FillBlankQuestion({ question, jsonData, onChange }) {
    _s();
    const [blanks, setBlanks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(jsonData || {});
...
_s(FillBlankQuestion, "kRocr2ib0oBe8tmDeMoL3vOft58=");
...
function MatchingQuestion({ question, jsonData, onChange }) {
    _s();
    const [matches, setMatches] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(jsonData || {});
...
_s(MatchingQuestion, "eod4o9vDoOBa2d905+ny8CpprMQ=");
_c = MatchingQuestion;
var _c;
...
'use client';
;
function CodeQuestion({ question, textAnswer, jsonData, onChange }) {
    _s();
    // Extract metadata
    const { language = 'javascript', placeholder = '// Write your code here...', initialCode = '' } = question.metadata || {};
    ...
    const handleChange = (e)=>{
        ...
        setCode(newCode);
        // Create metadata with execution info
        const codeData = {
            language,
            timestamp: new Date().toISOString(),
            executionStatus: null
        };
        onChange(newCode, codeData);
    };
...
__turbopack_context__.s({
    ...
    "parseQuestionMetadata": (()=>parseQuestionMetadata)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
function parseQuestionMetadata(metadata) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseMetadata"])(metadata);
}
function QuestionRenderer({ question, answer, onAnswerChange }) {
    _s();
    // Parse metadata once to ensure proper formatting
    const [parsedMetadata, setParsedMetadata] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    // Parse metadata when question changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuestionRenderer.useEffect": ()=>{
            const metadata = parseQuestionMetadata(question.metadata);
            console.log(`Question ${question.id} metadata:`, metadata);
        ...
        switch(question.type){
            ...
            case 'SHORT_ANSWER':
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$student$2f$quizzes$2f5b$quizId$5d2f$attempt$2f$essay$2d$question$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EssayQuestion"], {
                    question: {
                        ...
                        metadata: {
                            ...parsedMetadata,
                            maxWords: parsedMetadata?.maxWords || 50,
                            richText: false
                        }
                    },
                    textAnswer: currentAnswer.textAnswer || '',
            ...
            case 'CODE':
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$student$2f$quizzes$2f5b$quizId$5d2f$attempt$2f$code$2d$question$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CodeQuestion"], {
                    ...
                    textAnswer: currentAnswer.textAnswer || '',
                    jsonData: currentAnswer.jsonData || null,
                    onChange: (textAnswer, jsonData)=>handleAnswerChange({
                            textAnswer,
                            jsonData: jsonData || null
                        })
                }, void 0, false, {
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDescription"], {
                            children: "This question type is not supported in the current version."
                        }, void 0, false, {
                            fileName: "[project]/app/dashboard/student/quizzes/[quizId]/attempt/components/question-renderer.tsx",
                            lineNumber: 285,
                            columnNumber: 13
    ...
    const sanitizeContent = (html)=>{
        // This is a simple implementation. Consider using a proper sanitizer library
        // like DOMPurify in a production environment
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    dangerouslySetInnerHTML: {
                        __html: sanitizeContent(question.content)
                    }
                }, void 0, false, {
                    fileName: "[project]/app/dashboard/student/quizzes/[quizId]/attempt/components/question-renderer.tsx",
                    lineNumber: 304,
...
_s(QuestionRenderer, "jmjZRhpBqhYBwpNs3HJXzRurhGM=");
_c = QuestionRenderer;
var _c;
...
function QuizTake({ quizId }) {
    ...
    const [localAnswers, setLocalAnswers] = useLocalStorage(`quiz-answers-${quizId}`, {});
    // Initialize attempt
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "QuizTake.useEffect": ()=>{
            const startAttempt = {
...
//# sourceMappingURL=_f4786cca._.js.map
  ...
  return (
    <div className="flex flex-col space-y-6 max-w-md w-full mx-auto">
      <div className="flex flex-col space-y-2 text-center">
        ...
        <p className="text-muted-foreground">Join the online assessment platform</p>
      </div>

      <div className="space-y-4">
        <Card className="border shadow-sm">
          <CardHeader className="space-y-1">
            <CardTitle className="text-xl">Get started with Google</CardTitle>
            <CardDescription>
          ...
          <CardFooter className="flex flex-col space-y-2 border-t bg-muted/50 px-6 py-4">
            <p className="text-xs text-muted-foreground text-center">
              Your Google account will be used to identify you on the platform.

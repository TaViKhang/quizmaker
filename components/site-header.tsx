...
export function SiteHeader() {
  ...
  const headerBgClass = isScrolled 
    ? isDarkTheme 
      ...
      : "bg-background/95 border-border shadow-sm"
    : isDarkTheme
      ? "bg-gray-900/95 border-gray-800/30 shadow-md" 
      : "bg-blue-950/90 border-blue-900/20 shadow-md";
                  ...
                  <li>
                    <NavigationMenuLink asChild>
                      <a href="/proctoring" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                        ...
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                              Ensure testing integrity and security
                            </p>
                          </a>
                        </NavigationMenuLink>
                      </li>
                      <li>
                        <NavigationMenuLink asChild>
                          <a href="/analytics" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground">
                            <div className="text-sm font-medium leading-none">Analytics</div>
                            <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                              Powerful insights and reporting tools
                        </p>
                      </a>
                    </NavigationMenuLink>
                  </li>
